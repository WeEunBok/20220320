...
access = "wIeZ7Dmx3Tyrx6fcZeKilRsYWJtcX3iZkmCLCIVF"          # 본인 값으로 변경
secret = "XnAxVXGOYhwNLyy5z7TwIcFxvI4bqLEr1VDYm70K"          # 본인 값으로 변경
...
while True:
    try:
        ...
        if krw != 0 and (rsi_arr[186] < 40 or rsi_arr[185] < 40) and (rsi_arr[184] - rsi_arr[185]) < 0 and (rsi_arr[185] - rsi_arr[186]) >= 0 and (yhat_avg >= 1):
            #로그인찍기위함
            if krw > 5000:
                upbit.buy_market_order(KRW_coin, krw*0.9995) # 비트코인 매수
